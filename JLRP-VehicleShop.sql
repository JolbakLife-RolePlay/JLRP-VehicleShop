...
INSERT INTO `motorcycle_categories` (name, label) VALUES
...
INSERT INTO `motorcycles` (name, model, price, category) VALUES
    ...
    ('BMX (velo)', 'bmx', 160, 'bikes'),
    ('Cruiser (velo)', 'cruiser', 510, 'bikes'),
    ('Fixter (velo)', 'fixter', 225, 'bikes'),
    ('Scorcher (velo)', 'scorcher', 280, 'bikes'),
    ('Tri bike (velo)', 'tribike3', 520, 'bikes')
;